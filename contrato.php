   ...
   public function gerarPDF($fileName) {
    ...
    <body>
        ...
        <p class='leftParagraph'>
            CONVÊNIO DE CONCESSÃO DE ESTÁGIO PROFISSIONALIZANTE QUE ENTRE SI CELEBRAM '-RAZÃO SOCIAL EMPRESA-' E O CENTRO
            ESTADUAL DE EDUCAÇÃO TECNOLÓGICA PAULA SOUZA, POR INTERMÉDIO DA FACULDADE DE TECNOLOGIA DE PRESIDENTE PRUDENTE –
            FATEC 157.
        </p>
        <p>
            Pelo presente instrumento, a '-RAZÃO SOCIAL EMPRESA-', com sede à '-ENDEREÇO DA EMPRESA-', inscrita no CNPJ/MF
            sob o n.º $this->cnpjEmpresa, neste ato representada por '-NOME REPRESENTANTE EMPRESA-' doravante designada
        ...
        <p class='pDireita'>Presidente Prudente - SP, '-INÍCIO DO CONTRATO-'</p>
        <br>
        <br>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class='DivOrganizes1'>
                        <p class='PStyle'>-NOME REPRESENTANTE EMPRESA-<br>
            ...
            <tr>
                <td>
                    <p class='PStyle'>-NOME ORIENTADOR ESTAGIO-</p>
                    <P class='PStyle'>-RG ORIENTADOR ESTAGIO-</P>
                </td>
                <td></td>
                <td>
                    <p class='PStyle'>-NOME COORDENADOR CURSO-</p>
                    <p class='PStyle'>-RG COORDENADOR CURSO-</p>
                </td>
            </tr>
        </table>
        <br>
